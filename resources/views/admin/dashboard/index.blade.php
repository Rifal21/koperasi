                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      ...
                      <span class="text-white text-sm">Total Barang</span>
                    </div>
                    <div class="col-4">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://fkstudio.my.id" class="font-weight-bold" target="_blank">FKStudio</a>.
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://fkstudio.my.id" class="nav-link text-muted" target="_blank">FKStudio</a>
                </li>
                <li class="nav-item">
                  <a href="https://fkstudio.my.id" class="nav-link text-muted" target="_blank">About Us</a>
                </li>
                <li class="nav-item">
                  <a href="https://fkstudio.my.id" class="nav-link text-muted" target="_blank">Blog</a>
                </li>
                <li class="nav-item">
                  <a href="https://fkstudio.my.id" class="nav-link pe-0 text-muted" target="_blank">License</a>
                </li>
              </ul>
            </div>
          </div>
